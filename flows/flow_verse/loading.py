...
def load_class(repository_id, class_name, cache_dir=DEFAULT_CACHE_PATH, local_dir=None):
    logger.warn(f"{colorama.Fore.RED}loading {class_name}, [load_class] is deprecated, please use [sync_dependencies] and normal import{colorama.Style.RESET_ALL}")
...
def instantiate_flow(repository_id, class_name, cache_dir=DEFAULT_CACHE_PATH, local_dir=None, overrides={}): # TODO(yeeef): this default value might cause problems
    logger.warn(f"{colorama.Fore.RED}[instantiate_flow] is deprecated, please use [sync_dependencies] and normal import{colorama.Style.RESET_ALL}")
    flow_class = load_class(repository_id=repository_id,
                            local_dir=local_dir,
                            class_name=class_name,
                            cache_dir=cache_dir)
