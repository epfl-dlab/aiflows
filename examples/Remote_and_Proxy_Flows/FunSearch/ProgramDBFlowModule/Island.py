...
class Island:
    ...
    def pick_clusters(self):
        ...
        probs = scipy.special.softmax(cluster_scores / cluster_temperature, axis=-1)
    ...
    def get_prompt(self):
        ...
        return self._generate_prompt(sorted_implementations,chosen_cluster_names),version_generated
