...
class ProgramDBFlow(AtomicFlow):
    ...
    def _register_program_in_island(self,program: AbstractArtifact, scores_per_test: ScoresPerTest, island_id: Optional[int] = None):
        ...
        scores_per_test_values = np.array(list(scores_per_test.values()))
        ...
        if score > self.flow_state["best_score_per_island"][island_id]:
            ...
            self.flow_state["best_program_per_island"][island_id] = program
    ...
    def run(self,input_data: Dict[str,any]):
        ...
        possible_operations = ["register_program","get_prompt","get_best_programs_per_island","register_evaluate_functions"]
        ...
        if operation == "get_prompt":
            ...
            response["retrieved"] = {"code":code,"version_generated":version_generated,"island_id":island_id, "evaluate_file_full_content": self.evaluate_file_full_content}
